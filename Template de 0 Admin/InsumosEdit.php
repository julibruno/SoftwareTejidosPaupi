<?php 
	...
	$id=$_GET['id'];
	$sql="SELECT Descripcion, DescripcionAbre, Color,  Cantidad
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Editar Insumo</h2>
                 ...
                 -->   
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Editar Insumo:  <?php echo $ver[0] ?> </h5>
                                <div class="card-body">
                                    <form class="needs-validation" novalidate action="Controller/Insumos/actualizar.php? <?php echo $id ?>" method="post" id="Form_Edit_Insumo">
                                        <div class="row">
                                        <div class="EspacioSup col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 ">
                                            ...
                                            <div class="EspacioSup col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 ">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom02" placeholder="" value="<?php echo $ver[3] ?>" name="Cantidad" disabled>
                                    ...
                                    -->
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <div class="EspacioSup col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 ">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom02" placeholder="" value="<?php echo $ver[2] ?>" name="Color" required>
                                            ...
                                            <div class="EspacioSup col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <a  class="btn btn-secondary"  href="Insumos.php"> Cancelar </a>
